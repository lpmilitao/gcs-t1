...
public class Eventos {
    ...
    public int getQuantidadeTotalIngressos(){return quantidadeTotalIngressos;}
    public ArrayList<Ingresso> getIngressosGeral(){return ingressosGeral;}
    public ArrayList<Ingresso> getIngressosEspeciais(){return ingressosEspeciais;}
    ...
    public void toStr() {
        ...
        System.out.println("EVENTO NÚMERO: "+ codigoUnico);
        System.out.println("--- "+nomeEvento+" ---");
        System.out.println("DATA: "+date+"" +
                "\nVALOR INGRESSO: R$ "+valorIngresso+"" +
                "\nOFERECIDO POR: "+nomeResponsavel);
        System.out.println("LOTAÇÃO MÁXIMA: "+quantidadeTotalIngressos+" pessoas." +
                "\nPÚBLICO GERAL: "+capGer+"" +
    ...
    public void preenche(){
        ...
        codigoUnico = input.nextInt();input.nextLine();
        ...
        double aux = input.nextDouble();input.nextLine();
        if (aux > 0.0){
            valorIngresso = aux;
        }else{
        ...
        quantidadeTotalIngressos = input.nextInt();input.nextLine();
    }
    ...
    public void listarIngressosDisponiveis(){
        ...
        int contG=0,contE=0;
        for(int i=0; i<ingressosGeral.size(); i++){
            if(ingressosGeral.get(i)!=null){contG++;}
        }
        for(int i=0; i<ingressosEspeciais.size(); i++){
            if(ingressosEspeciais.get(i)!=null){contE++;}
        }
    ...
    public int numIngressosVendidos(){
        int cont=0;
        for(int i=0; i<ingressosGeral.size(); i++){
            if(ingressosGeral.get(i)!=null){cont++;}
        }
        for(int i=0; i<ingressosEspeciais.size(); i++){
            if(ingressosEspeciais.get(i)!=null){cont++;}
        }
        return cont;
    }
}
